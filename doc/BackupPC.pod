...
failed disks.  See L<Limitations> for more information.
...
L<Limitations> section for more discussion of this problem.
...
BackupPC-3.3.0.tar.gz, run these commands as root:
...
available, eg: BackupPC-3.3.0pl2.diff, you should apply
